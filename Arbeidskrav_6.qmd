...
### Kroppssammensetning
Kroppssammensetningen ble bestemt før og etter intervensjonen ved hjelp av dual-energy X-ray absorptiometry (DXA) (Lunar Prodigy, GE Healthcare, Oslo, Norge), i samsvar med standard protokoll. Før DXA-målingene ble deltakerne bedt om å være fastende i 2 timer og å avstå fra tung fysisk aktivitet i minimum 48 timer. To dager skilte den siste styrketesten fra målingene av kroppssammensetning.
...
## Results
Totalt førte treningsintervensjonen til en økning på 193 gram (2,25%) i mager masse og 92,31 (55,4%) kg økning i 1RM beinpress. Gruppen som gjennomførte 3 sett per øvelse hadde en 123 (73,9%) gram større økning i magermasse sammenlignet med gruppen som trente 1 sett (SE = 56,1, t = 2,19, 95% konfidensintervall [KI]: 8,6 –¬¬ 237,0, p = 0,0359). Gruppen som trente med 3 sett per øvelse hadde 7,8 kg (12,5%) større økning enn gruppen med 1 sett (SE = 3,31, t = 2,36, 95% KI: 1,1 –¬¬ 14,6, p = 0,025)
...
leanmass %>%
  ...
  theme_minimal() +
  labs(
    title = "Gjennomsnittlig mager masse",
    x = "Tidspunkt",
    y = "Antall gram"
  ) +
